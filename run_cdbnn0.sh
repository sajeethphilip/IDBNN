...
case $mode in
  ...
  "train" | "all"| "fresh")
    ...
    python cdbnn0.py --mode train --data_name "$data_name" --input_path "$input_path" --encoder_type "$encoder_type"
    python cdbnn0.py --mode predict --data_name "$data_name" --input_path "$input_path" --encoder_type "$encoder_type"
