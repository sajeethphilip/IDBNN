...
#Tested an fully functional April 4 2025 2:41 am
import torch
import time
import argparse
...
#--------------------------------------------------Class Ends ----------------------------------------------------------
    ...
    def predict_from_file_old(self, input_csv_path, output_dir, image_dir=None, batch_size=128):
        ...
        Returns:
            DataFrame containing prediction results or None if aborted
        """
        try:
            # Handle existing output path
            ...
            if has_ground_truth:
                ...
                print(f"\n{Colors.BLUE}Classification Report:{Colors.ENDC}")
                print(report)
